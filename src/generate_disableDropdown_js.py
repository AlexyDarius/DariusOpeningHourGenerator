def generate_disableDropdown_js(directory_path):
...
'''
    ...
    with open(f"{directory_path}/opening-hours/js/disableDropdown.js", "w") as js_file:
        js_file.write(js_code)
        print("disableDropdown.js generated !")
