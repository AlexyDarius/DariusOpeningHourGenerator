def generate_openingOpeningHoursNoon_js(directory_path):
...
'''
    ...
    with open(f"{directory_path}/opening-hours/js/updateOpeningHoursNoon.js", "w") as js_file:
        js_file.write(js_code)
        print("updateOpeningHoursNoon.js generated !")
